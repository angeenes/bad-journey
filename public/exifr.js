!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : t(
        ((e = "undefined" != typeof globalThis ? globalThis : e || self).exifr =
          {})
      );
})(this, function (e) {
  "use strict";
  ...
  function g(e) {
    return (
      ...
      (e instanceof Map
        ? 0 === e.size
        : 0 === Object.values(e).filter(p).length)
    );
  }
  function m(e) {
    let t = new Error(e);
  ...
  class oe extends ne {
    ...
    get onlyTiff() {
      return (
        !J.map((e) => this[e].enabled).some((e) => !0 === e) &&
        this.tiff.enabled
      );
    }
    checkLoadedPlugins() {
  ...
  class ce {
    ...
    setup() {
      ...
      for (let [i, n] of T)
        if (n.canHandle(e, t))
          return (
            (this.fileParser = new n(this.options, this.file, this.parsers)),
            (e[i] = !0)
          );
  ...
  class ge {
    ...
    translateBlock(e, t) {
      ...
      for (let [t, r] of e)
        a && i.has(t)
          ? (r = i.get(t)(r))
          : o && n.has(t) && (r = this.translateValue(r, n.get(t))),
  ...
  class ye extends pe {
    ...
    setupSegmentFinderArgs(e) {
      !0 === e
        ...
        : ((e =
            void 0 === e
              ? A.keyList().filter((e) => this.options[e].enabled)
              : e.filter((e) => this.options[e].enabled && A.has(e))),
          (this.findAll = !1),
      ...
      if (
        ...
        for (
          ...
          let { nextChunkOffset: n } = i,
            s = this.appSegments.some(
              (e) =>
                !this.file.available(e.offset || e.start, e.length || e.size)
            );
          if (
            ((t =
              e > n && !s
                ? !(await i.readNextChunk(e))
                : !(await i.readNextChunk(n))),
                ...
                !h &&
                  (r.multiSegment && o.multiSegment
                    ? ((this.unfinishedMultiSegment =
                      ...
                      this.unfinishedMultiSegment || c.delete(s))
                    : c.delete(s),
                  0 === c.size)))
            )
              break;
            f.recordUnknownSegments &&
              ((a = ge.findPosition(l, e)),
              (a.marker = i),
              this.unknownSegments.push(a)),
              (e += n + 1);
          } else if (me(i)) {
            if (((n = l.getUint16(e + 2)), 218 === i && !1 !== f.stopAfterSos))
              return;
            f.recordJpegSegments &&
              this.jpegSegments.push({ offset: e, length: n, marker: i }),
              (e += n + 1);
          }
      return e;
    }
    ...
    parseTags(e, t, i = new Map()) {
      ...
      for (let l = 0; l < o; l++) {
        ...
        if (r) {
          if (
            n.has(o) &&
            (i.set(o, this.parseTag(e, o, t)), n.delete(o), 0 === n.size)
          )
            break;
  ...
  class Ie extends Pe {
    ...
    async parseExifBlock() {
      ...
      if (
        ...
        return;
      this.file.tiff &&
        (await this.file.ensureChunk(this.exifOffset, C(this.options)));
    ...
    async parseGpsBlock() {
      if (this.gps) return;
      if (
        (this.ifd0 || (await this.parseIfd0Block()), void 0 === this.gpsOffset)
      )
        return;
      ...
      return (
        e &&
          e.has(2) &&
          e.has(4) &&
          (e.set("latitude", ke(...e.get(2), e.get(1))),
  ...
  if (
    ((e.rotateCanvas = !0), (e.rotateCss = !0), "object" == typeof navigator)
  ) {
  ...
  D.set(
    ...
    class extends Ne {
      async readWhole() {
        ...
        e instanceof ArrayBuffer
          ? this._swapArrayBuffer(e)
          : e instanceof Uint8Array && this._swapBuffer(e);
      }
      async _readChunk(e, t) {
        ...
        let s = await u(this.input, { headers: n }),
          ...
          a = r.byteLength;
        if (416 !== s.status)
          return a !== t && (this.size = e + a), this.set(r, e, !0);
      }
    }
  );
  ...
  class Ve extends pe {
    ...
    findBox(e, t) {
      return (
        void 0 === e.boxes && this.parseSubBoxes(e),
    ...
    parseBoxHead(e) {
      let t = this.file.getUint32(e),
        ...
        n = e + 8;
      return (
        1 === t && ((t = this.file.getUint64(e + 8)), (n += 8)),
        { offset: e, length: t, kind: i, start: n }
      );
    }
    parseBoxFullHead(e) {
  ...
  class ze extends Ve {
    ...
    async findIcc(e) {
      ...
      void 0 !== n &&
        (await this.registerSegment("icc", n.offset + 12, n.length));
    }
    async findExif(e) {
  ...
  function Ye(e) {
    ...
    return (
      t[1] > 15 && (t = t.map((e) => String.fromCharCode(e))),
      ("0" !== t[2] && 0 !== t[2]) || t.pop(),
      t.join(".")
    );
  }
    ...
    if ("string" == typeof e) {
      ...
      return (
        Number.isNaN(s) ||
          Number.isNaN(r) ||
          Number.isNaN(a) ||
          (o.setHours(s), o.setMinutes(r), o.setSeconds(a)),
        Number.isNaN(+o) ? e : o
      );
    }
  }
  function Je(e) {
    ...
    if (0 === e[1] && 0 === e[e.length - 1])
      for (let i = 0; i < e.length; i += 2) t.push(qe(e[i + 1], e[i]));
  ...
  class et extends ge {
    static canHandle(e, t) {
      return (
        225 === e.getUint8(t + 1) &&
        1752462448 === e.getUint32(t + 4) &&
        e.getString(t + 4, Qe.length) === Qe
      );
    }
    static headerLength(e, t) {
      return e.getString(t + 4, Ze.length) === Ze
        ? 79
        : 4 + "http://ns.adobe.com/xap/1.0/".length + 1;
    }
    static findPosition(e, t) {
      ...
      return (
        ...
        i.multiSegment
          ? ((i.chunkCount = e.getUint8(t + 72)),
            (i.chunkNumber = e.getUint8(t + 76)),
            0 !== e.getUint8(t + 77) && i.chunkNumber++)
  ...
  class tt {
    static findAll(e) {
      return lt(e, /([a-zA-Z0-9-]+):([a-zA-Z0-9-]+)=("[^"]*"|'[^']*')/gm).map(
        tt.unpackMatch
      );
    }
    ...
    class extends Ne {
      constructor(...e) {
        super(...e),
          ...
          this.input.endsWith("==")
            ? (this.size -= 2)
            : this.input.endsWith("=") && (this.size -= 1);
      }
      async _readChunk(e, t) {
        let i,
          n,
  ...
  class Tt extends pe {
    ...
    static canHandle(e, t) {
      return (
        35152 === t &&
        2303741511 === e.getUint32(0) &&
        218765834 === e.getUint32(4)
      );
    }
    async parse() {
      let { file: e } = this;
    ...
    async findXmp() {
      ...
      for (let t of e) {
        t.chunk.getString(0, yt.length) === yt &&
          this.injectSegment("xmp", t.chunk);
      }
    }
    async findIcc() {
      ...
      for (; a--; ) {
        if (
          ...
          return void console.warn(
            "reached the end of the first ICC chunk. Enable options.tiff.multiSegment to read all ICC segments."
          );
  ...
  const Mt = {
    4: Rt,
    8: function (e, t) {
      return [e.getUint8(t), e.getUint8(t + 1) >> 4, e.getUint8(t + 1) % 16]
        .map((e) => e.toString(10))
        .join(".");
    },
    12: Rt,
  ...
  class Ft extends ge {
    static canHandle(e, t, i) {
      return (
        237 === e.getUint8(t + 1) &&
        "Photoshop" === e.getString(t + 4, 9) &&
        void 0 !== this.containsIptc8bim(e, t, i)
      );
    }
    ...
    static containsIptc8bim(e, t, i) {
      for (let n = 0; n < i; n++)
        if (this.isIptcSegmentHead(e, t + n)) return n;
    }
    static isIptcSegmentHead(e, t) {
      return (
        56 === e.getUint8(t) &&
        943868237 === e.getUint32(t) &&
        1028 === e.getUint16(t + 4)
      );
    }
    parse() {
      let { raw: e } = this,
